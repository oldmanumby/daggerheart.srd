...
Make an attack against a target within Very Close range. On a success, spend a Hope to use the attack against all other targets within Very Close range. All additional adversaries you succeed against with this ability take half damage.

### A SOLDIER'S BOND

**Card:** A Soldier's Bond
...
When you're targeted by an attack made from beyond Melee range, you can **mark a Stress** to roll a **d4** and gain a bonus to your Evasion equal to the result.
